...
import { u as useField, w as useForm, x as MemoizedStringInput, F as Form, b as Layouts, B as BackButton, M as MemoizedInputRenderer } from './index-DbsOttc5.mjs';
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import('./EventsTable-CsohXy29.mjs')).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-DTcwVvA3.mjs.map
