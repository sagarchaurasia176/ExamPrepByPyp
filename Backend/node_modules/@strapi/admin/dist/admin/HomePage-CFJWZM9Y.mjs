...
import { b as Layouts, v as ContentBox } from './index-DbsOttc5.mjs';
...
const HomePage = () => {
  const Page2 = useEnterprise(
    ...
    async () => (await import('./HomePage-BIYGWMo6.mjs')).HomePageEE
  );
  if (!Page2) {
    return null;
  }
...
//# sourceMappingURL=HomePage-CFJWZM9Y.mjs.map
