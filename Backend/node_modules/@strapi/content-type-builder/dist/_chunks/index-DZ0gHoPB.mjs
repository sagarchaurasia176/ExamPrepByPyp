...
const ListView$1 = lazy(() => import("./ListView-C40qzY4p.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-C40qzY4p.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-DZ0gHoPB.mjs.map
