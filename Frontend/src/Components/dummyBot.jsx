  ...
  return (
    <>
      ...
      {!isOpen && (
        <div className="fixed bottom-6 right-6 z-50">
          ...
          >
            ...
            {/* Hover tooltip */}
            <div className="absolute bottom-full right-0 mb-2 bg-orange-300 text-white px-3 py-1.5 rounded-lg text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap">
              Chat with AI
      ...
      {isOpen && (
        ...
        >
          <div className="bg-slate-900 rounded-xl shadow-2xl border border-gray-200 flex flex-col h-full overflow-hidden">
            {/* Header */}
            ...
            {!isMinimized && (
              <>
                {/* Messages Container */}
                <div className="flex-1 overflow-y-auto p-4 space-y-4  bg-slate-900 text-white">
                  {/* Welcome Screen */}
                  {showWelcome && messages.length === 0 && (
                    <div className="text-center py-8">
                      <div className="w-16 h-16 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4">
                        <Bot className="w-8 h-8  bg-slate-900 text-white" />
                      </div>
                      <h3 className="text-lg font-medium text-white  mb-2">
                        Welcome! I'm your AI Assistant 👋
                      </h3>
                      <p className="text-sm text-gray-400 mb-6 leading-relaxed">
                        I'm here to help with your questions, provide
                        explanations, and assist with your studies.
                      </p>
                  ...
                  {messages.map((message) => (
                    ...
                    >
                      <div
                        className={`flex max-w-xs text-black lg:max-w-md ${
                          message.role === "user"
                            ? "flex-row-reverse"
                            : "flex-row"
                        } space-x-2`}
